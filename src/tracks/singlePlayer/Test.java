...
public class Test {
    ...
    public static void main(String[] args) {
		...
		//rhNEAT controller
		String sampleRHNEATController = "tracks.singlePlayer.advanced.sampleRHNEAT.Agent";
		...
		ArcadeMachine.runOneGame(game, level1, visuals, sampleRHNEATController, recordActionsFile, seed, 0);
